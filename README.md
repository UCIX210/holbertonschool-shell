![image](/img/shell.jpeg)
# **Shell**
Release date February 6, 2023
</p>

## **In this repository you will find the projects on the basic concepts of UNIX shells**
...
|---|---|---|
|**Baics**|[basics](https://github.com/UCIX210/holbertonschool-shell/tree/main/basics)|First commands and terminal basics|
|-|-|-|
|-|-|-|
|-|-|-|
|<sub>_Images_</sub>|[<sub>_img_</sub>](https://github.com/UCIX210/holbertonschool-shell/tree/main/img)|<sub>_Images used as resources for the Github README.md (Not a project)_</sub>|
